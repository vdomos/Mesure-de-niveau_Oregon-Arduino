...
Il est possible d'émuler une sonde Oregon avec un Arduino et un émetteur RF 433MHz avec l'execelent code disponible ici:
http://connectingstuff.net/blog/encodage-protocoles-oregon-scientific-sur-arduino/

Il est possible d'emettre des trames de 2 types de sondes Oregon comme la sonde de température **thn132n** et la sonde de température/humidité **thgr228n**.
...
* Un ci Arduino: ATtiny85 (Voir ce lien http://highlowtech.org/?p=1695 pour programmer l'ATtiny85 sous Arduino.) 
