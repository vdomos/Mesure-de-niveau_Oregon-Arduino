...
ATTENTION: - L'ATtiny85 doit être configuré en hhorloge 8 MHz pour respecter les timing RF
...
* Déduire des graphes obtenus, la consommation de sel.
...
image:images/OregonSol_ATtiny85_Wdt_1.png[caption="", title="", alt="Graphes sur 36 heures", width="800", link="images/OregonSol_ATtiny85_Wdt_1.png"] 
